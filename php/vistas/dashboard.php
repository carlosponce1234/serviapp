  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="home.php">
        ...
        <div class="sidebar-brand-text mx-3">Serviapp</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" id="sucursal" href="#">sucursales</a>
            <h6 class="collapse-header">Control de usuarios</h6>
            <a class="collapse-item" id="addusuario" href="#">Agragar Usuario</a>
            ...
            <h6 class="collapse-header">Control de flota y conductores</h6>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">operaciones Ventas</h6>
            <a class="collapse-item" href="#">Pre-Factura</a>
            <a class="collapse-item" href="#">Anulaciones</a>
            <a class="collapse-item" href="#">Caja</a>
            <a class="collapse-item" href="#">Ordenes Trabajo</a>
          </div>
        </div>
      </li>
